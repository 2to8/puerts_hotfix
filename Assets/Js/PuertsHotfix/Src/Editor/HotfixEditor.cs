...
namespace Puerts
{
    public class HotfixEditor
    {
        ...
        public static void InjectAssembly(string assembly)
        {
            ...
            var getHotfixConfig = GetHotfixConfigMethod();
            var codeDir = GetHotfixCodeDirectory();
        ...
        public static MethodInfo GetHotfixConfigMethod()
        {
            var types = from assembly in AppDomain.CurrentDomain.GetAssemblies()
                        where !(assembly.ManifestModule is System.Reflection.Emit.ModuleBuilder)
                        from type in assembly.GetTypes()
        ...
        /// <summary> 获取Hotfix 生成Code文件夹 </summary>
        public static string GetHotfixCodeDirectory()
        {
            var types = from assembly in AppDomain.CurrentDomain.GetAssemblies()
                        where !(assembly.ManifestModule is System.Reflection.Emit.ModuleBuilder)
                        from type in assembly.GetTypes()
            ...
            foreach (var type in types)
            {
                ...
                foreach (PropertyInfo prop in props)
                {
                    ...
                    {
                        HotfixCodeDirectoryAttribute outAttr = attr as HotfixCodeDirectoryAttribute;
                        if (outAttr != null)
                        {
            ...
            return UnityEngine.Application.dataPath + "/Js/PuertsHotfix/Resources/";
        }
        #endregion
